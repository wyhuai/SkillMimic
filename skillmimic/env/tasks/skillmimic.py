...
class SkillMimicBallPlay(HumanoidWholeBodyWithObject): 
    ...
    def _reset_random_ref_state_init(self, env_ids): #Z11
        ...
        self.init_root_pos, self.init_root_rot,  self.init_root_pos_vel, self.init_root_rot_vel, self.init_dof_pos, self.init_dof_pos_vel, \
        self.init_obj_pos, self.init_obj_pos_vel, self.init_obj_rot, self.init_obj_rot_vel \
